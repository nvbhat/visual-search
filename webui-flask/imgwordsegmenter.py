...
#Usage:->python imgwordsegmenter.py -j visual-search/indexedbooks/Kandanu.json -b Kansegment.json(give any file name to save the segmented result)
...
outfile = open ( "static/visual-search/segmented-books/"+outputjsonfile,'w' )
# Load the image
