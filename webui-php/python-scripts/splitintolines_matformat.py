...
def DisplayWordBoundaries(img,segbookfilename,root_dir):
    
    bookdir = root_dir+configobj.segbook_dir
    resultimgdir= root_dir+configobj.segresultimg_dir
    #print bookdir ,";" ,resultimgdir
    ...
    f.write(str5)
    f.close()
    cv2.imwrite(resultimgdir+segimgname,out3)
    ...
    obj.segimgname=bookdir+segbookfilename
    print obj.segimgname
    #return obj.segimgname
    
    #print "visual-search/segmented-books/"+segbookfilename;
    #shutil.copy2("visual-search/segmented-books/"+segbookfilename, "book-result.json")
    #print "visual-search/segmented-books/"+"book-result.json"
