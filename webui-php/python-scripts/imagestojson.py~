...
for i in range(1, len(sys.argv)-2):
    ...
    #if(length==4):
    temp=sys.argv[i+1];
    abs_path = sys.argv[i+2]  

jsonfile_dir = abs_path+configobj.idxbooks 
#print jsonfile_dir
imgupload_dir = abs_path + configobj.userupload_dir 
#print "temp=",temp
d['book']['images']=arr
json.dumps(d)
#print d['book']['images'];
...
with open(jsonfile_dir+temp, 'w') as outfile:
