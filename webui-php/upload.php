...
exec("python imagestojson.py $selectedimgfiles $bookname");//calling the python script for creating a book

$j = 0;     // Variable for indexing uploaded image.
$target_path = "example-images/user_uploads/";  // Declaring Path for uploaded images.
$selectedimages="";   
...
if ((($_FILES['file']['error'][$i] === UPLOAD_ERR_OK)&&($_FILES["file"]["size"][$i] < 10000000 ))    
