...
//ini_set('upload_max_filesize', '64M');
 ...
 $target_path = $root_dir.$userupload_dir;  // Declaring Path for uploaded images.
...
//echo $selectedimgfiles;
 ...
 //echo $target_path;
 echo exec("python python-scripts/imagestojson.py $selectedimgfiles $bookname $root_dir");//calling the python script for creating a book
