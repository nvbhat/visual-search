       ...
       $my_array = array();
        ...
        $jpeg_quality = 100;
         ...
         if ($ext == "jpg" || $ext == "jpeg")
         {
          ...
          $tempimg="../../visual-search/template-images/croppedimage.jpg";
              if($set_threshold=='')
            {
             //$th_val=0.7;
          //echo exec("python fuzzyimgsearch.py -j ../../maindirectory/$book -i $tempimg -b $jsonresultfile  ");
            echo exec("python ../../python-scripts/fuzzyimgsearch.py -j $book -i $tempimg -b $jsonresultfile -t 0.7 ");
         
             }

             else
             {
                echo exec("python ../../python-scripts/fuzzyimgsearch.py -j $book -i $tempimg -b $jsonresultfile -t $set_threshold  ");
              }
         }
...
<!-- jjjjjjj-->     
	  ...
	  imagepng($dst_r_png,$savedircropimg_png."croppedimage.png");
          ...
          $tempimg="../../visual-search/template-images/croppedimage.png";          
         //echo exec("python fuzzyimgsearch.py -j ../../maindirectory/$book -i $tempimg -b $jsonresultfile");
            if($set_threshold == '')
            {
             // $th_val=0.7;
...
?>
   ...
   <?php
       ...
       $folder = "../../visual-search/searched-images/Template-Match/".$searched_images_dir."/";   
       $filetype = '*.'.'jpg';
